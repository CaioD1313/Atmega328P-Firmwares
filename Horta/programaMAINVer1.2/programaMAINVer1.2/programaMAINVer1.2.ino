 ...
 *******************************************/
 ...
 void irrigacao (void)
 {
  ...
  switch(day)
  {
    ...
    if(EEPROM.read(28)==1) // se o dia estiver habilitado então entra aqui
    {
    ...
    case 2: // segunda
     ...
     hour_irrig=EEPROM.read(2); // guarda em hour_irrig a hora que começa a irrigação (seg)
     minu_irrig=EEPROM.read(3); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig1=EEPROM.read(16); // guarda em hour_irrig a hora que começa a irrigação (seg)
     minu_irrig1=EEPROM.read(17); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig_duration=hour_irrig+hour_irrig1;
     minu_irrig_duration=minu_irrig+minu_irrig1;

    if(EEPROM.read(29)==1) // se o dia estiver habilitado então entra aqui
    {
    ...
    case 3: // terça 
     ...
     hour_irrig=EEPROM.read(4); // guarda em hour_irrig a hora que começa a irrigação (ter)
     minu_irrig=EEPROM.read(5); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig1=EEPROM.read(18); // guarda em hour_irrig a hora que começa a irrigação (ter)
     minu_irrig1=EEPROM.read(19); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig_duration=hour_irrig+hour_irrig1;
     minu_irrig_duration=minu_irrig+minu_irrig1;

    if(EEPROM.read(30)==1) // se o dia estiver habilitado então entra aqui
    {
    ...
    case 4: // quarta
     ...
     hour_irrig=EEPROM.read(6); // guarda em hour_irrig a hora que começa a irrigação (qua)
     minu_irrig=EEPROM.read(7); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig1=EEPROM.read(20); // guarda em hour_irrig a hora que começa a irrigação (qua)
     minu_irrig1=EEPROM.read(21); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig_duration=hour_irrig+hour_irrig1;
     minu_irrig_duration=minu_irrig+minu_irrig1;

    if(EEPROM.read(31)==1) // se o dia estiver habilitado então entra aqui
    {
    ...
    case 5:  // quinta
     ...
     hour_irrig=EEPROM.read(8); // guarda em hour_irrig a hora que começa a irrigação (qui)
     minu_irrig=EEPROM.read(9); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig1=EEPROM.read(22); // guarda em hour_irrig a hora que começa a irrigação (qui)
     minu_irrig1=EEPROM.read(23); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig_duration=hour_irrig+hour_irrig1;
     minu_irrig_duration=minu_irrig+minu_irrig1;

    if(EEPROM.read(32)==1) // se o dia estiver habilitado então entra aqui
    {
    ...
    case 6: // sexta
     ...
     hour_irrig=EEPROM.read(10); // guarda em hour_irrig a hora que começa a irrigação (sex)
     minu_irrig=EEPROM.read(11); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig1=EEPROM.read(24); // guarda em hour_irrig a hora que começa a irrigação (sex)
     minu_irrig1=EEPROM.read(25); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig_duration=hour_irrig+hour_irrig1;
     minu_irrig_duration=minu_irrig+minu_irrig1;

    if(EEPROM.read(33)==1) // se o dia estiver habilitado então entra aqui
    {
    ...
    case 7: // sábado
     ...
     hour_irrig=EEPROM.read(12); // guarda em hour_irrig a hora que começa a irrigação (sab)
     minu_irrig=EEPROM.read(13); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig1=EEPROM.read(26); // guarda em hour_irrig a hora que começa a irrigação (sab)
     minu_irrig1=EEPROM.read(27); // guarda em minu_irrig o min que começa a irrigação
     hour_irrig_duration=hour_irrig+hour_irrig1;
     minu_irrig_duration=minu_irrig+minu_irrig1;

    if(EEPROM.read(34)==1) // se o dia estiver habilitado então entra aqui
    {
  ...
  while(aux_setup==0) // hold da atualização da hora/min/seg
      {
       ...
       if(digitalRead(up)== HIGH && curs0r==7)
       {
        ...
        if(hour==deltaH) // se a hora chega na máxima zera o minuto para nao ter conflito de min>minuto max
          {
          minu=0;
          lcd.clear();
          }
...
void loop() {
   ...
   if(digitalRead(left)==HIGH) // se apertar botao esquerdo entra na programação do dia e hora da irrigação
    {
      ...
      ****************************************************************************/
        ...
        EEPROM.write(14,hour); // salva a hora programada na posição quatorze (domingo)
        EEPROM.write(15,minu); // salva o minuto programado na posição quinze (doming)
        aux_prog=2;
        aux_setup=0;
      ...
      ****************************************************************************/
        ...
        EEPROM.write(16,hour); // salva a hora programada na posição dezesseis(Seg)
        EEPROM.write(17,minu); // salva o minuto programado na posição dezessete (Seg)
        aux_prog=3;
        aux_setup=0;
      ...
      ****************************************************************************/
        ...
        EEPROM.write(18,hour); // salva a hora programada na posição dezoito (ter)
        EEPROM.write(19,minu); // salva o minuto programado na posição dezenove (ter)
        aux_prog=4;
        aux_setup=0;
      ...
      ****************************************************************************/
        ...
        EEPROM.write(20,hour); // salva a hora programada na posição vinte (quarta)
        EEPROM.write(21,minu); // salva o minuto programado na posição vinte e um (quarta)
        aux_prog=5;
        aux_setup=0;
      ...
      ****************************************************************************/
        ...
        EEPROM.write(22,hour); // salva a hora programada na posição vinte e dois (Quinta)
        EEPROM.write(23,minu); // salva o minuto programado na posição vinte e três (Quinta)
        aux_prog=6;
        aux_setup=0;
      ...
      ****************************************************************************/
        ...
        EEPROM.write(24,hour); // salva a hora programada na posição vinte e quatro(Sexta)
        EEPROM.write(25,minu); // salva o minuto programado na posição vinte e cinco (sexta)
        aux_prog=7;
        aux_setup=0;
      ...
      ****************************************************************************/
        ...
        EEPROM.write(26,hour); // salva a hora programada na posição vinte e seis (Sab)
        EEPROM.write(27,minu); // salva o minuto programado na posição vinte e sete (Sab)
        aux_setup=0;
 ...
 if(digitalRead(left)==HIGH) // se apertar botao esquerdo entra na programação do dia e hora da irrigação
      ...
      ****************************************************************************/
        ...
        e2prom_r=28; // posição da hab/desab do domingo na memoria
        e2prom_read(); // le a memoria com a posição dada da variavel e2prom_r
        able=e2prom_r_val;
        ...
        EEPROM.write(28,able); // salva a hora programada na posição vinte e oito (domingo)
      ...
      ****************************************************************************/
        ...
        e2prom_r=29; // posição da hab/desab da segunda na memoria
        e2prom_read(); // le a memoria com a posição dada da variavel e2prom_r
        able=e2prom_r_val;
        ...
        EEPROM.write(29,able); // salva a hora programada na posição vinte e nove (segunda)
      ...
      ****************************************************************************/
        ...
        e2prom_r=30; // posição da hab/desab da terça na memoria
        e2prom_read(); // le a memoria com a posição dada da variavel e2prom_r
        able=e2prom_r_val;
        ...
        EEPROM.write(30,able); // salva a hora programada na posição trinta (Terça)
      ...
      ****************************************************************************/
        ...
        e2prom_r=31; // posição da hab/desab da quarta na memoria
        e2prom_read(); // le a memoria com a posição dada da variavel e2prom_r
        able=e2prom_r_val;
        ...
        EEPROM.write(31,able); // salva a hora programada na posição trinta e um (Quarta)
      ...
      ****************************************************************************/
        ...
        e2prom_r=32; // posição da hab/desab da quinta na memoria
        e2prom_read(); // le a memoria com a posição dada da variavel e2prom_r
        able=e2prom_r_val;
        ...
        EEPROM.write(32,able); // salva a hora programada na posição trinta e dois (Quinta)
      ...
      ****************************************************************************/
        ...
        e2prom_r=33; // posição da hab/desab da sexta na memoria
        e2prom_read(); // le a memoria com a posição dada da variavel e2prom_r
        able=e2prom_r_val;
        ...
        EEPROM.write(33,able); // salva a hora programada na posição trinta e três (Sexta)
      ...
      ****************************************************************************/
        ...
        e2prom_r=34; // posição da hab/desab do domingo na memoria
        e2prom_read(); // le a memoria com a posição dada da variavel e2prom_r
        able=e2prom_r_val;
        ...
        EEPROM.write(34,able); // salva a hora programada na posição trinta e quatro (Sábado)
